...
gdjs.stage1Code.GDNewText6Objects1= [];
gdjs.stage1Code.GDNewText6Objects2= [];
...
gdjs.stage1Code.asyncCallback11213932 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.stage1Code.asyncCallback11213932(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.stage1Code.mapOfGDgdjs_46stage1Code_46GDenemyObjects1Objects = Hashtable.newFrom({"enemy": gdjs.stage1Code.GDenemyObjects1});
gdjs.stage1Code.asyncCallback11217828 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "syouten", false);
}}
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.stage1Code.asyncCallback11217828(runtimeScene, asyncObjectsList)));
}
}
...
gdjs.stage1Code.asyncCallback11219844 = function (runtimeScene, asyncObjectsList) {
{gdjs.evtTools.runtimeScene.replaceScene(runtimeScene, "syouten", false);
}}
...
{
const asyncObjectsList = new gdjs.LongLivedObjectsList();
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.stage1Code.asyncCallback11219844(runtimeScene, asyncObjectsList)));
}
}
...
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11184588);
}
}
if (isConditionTrue_0) {
...
}{runtimeScene.getScene().getVariables().get("stage1cleartime").setNumber(0);
}}
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11209852);
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11212716);
}
}
}
if (isConditionTrue_0) {
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11217044);
}
}
if (isConditionTrue_0) {
/* Reuse gdjs.stage1Code.GDPlayerObjects1 */
...
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.stage1Code.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.stage1Code.GDPlayerObjects1[i].getBehavior("PlatformerObject").isOnFloor() ) {
        isConditionTrue_0 = true;
        gdjs.stage1Code.GDPlayerObjects1[k] = gdjs.stage1Code.GDPlayerObjects1[i];
        ++k;
    }
...
if (isConditionTrue_0) {
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11219492);
}
}
}
if (isConditionTrue_0) {
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
isConditionTrue_0 = gdjs.evtsExt__RepeatEveryXSeconds__Repeat.func(runtimeScene, "time", 1, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("NewText6"), gdjs.stage1Code.GDNewText6Objects1);
{runtimeScene.getScene().getVariables().get("stage1cleartime").add(1);
}{for(var i = 0, len = gdjs.stage1Code.GDNewText6Objects1.length ;i < len;++i) {
    gdjs.stage1Code.GDNewText6Objects1[i].setString(gdjs.evtTools.common.toString(gdjs.evtTools.variable.getVariableNumber(runtimeScene.getScene().getVariables().get("stage1cleartime"))));
}
}}
...
gdjs.stage1Code.GDNewText6Objects1.length = 0;
gdjs.stage1Code.GDNewText6Objects2.length = 0;
