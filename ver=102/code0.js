...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11178316);
}
if (isConditionTrue_0) {
...
};gdjs.titleCode.asyncCallback11178412 = function (runtimeScene, asyncObjectsList) {
