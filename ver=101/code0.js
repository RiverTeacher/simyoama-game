...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
{isConditionTrue_0 = runtimeScene.getOnceTriggers().triggerOnce(11022948);
}
if (isConditionTrue_0) {
...
};gdjs.titleCode.asyncCallback11023044 = function (runtimeScene, asyncObjectsList) {
